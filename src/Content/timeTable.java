 ...
 *                              time table
 */
   protected void setim(Entity newEntity, int time){
     int i = 0;
 ...
 *				false otherwise
 */
   protected boolean moreEntities(Entity removedEntity){
 ...
 */
   protected boolean delete(Entity entityToDelete){
     int index;
 ...
 */
   protected boolean retim(Entity entityToChange, int newTime){
     int index;
...
/**
  ...
  */
   protected void adjust(Entity item){
